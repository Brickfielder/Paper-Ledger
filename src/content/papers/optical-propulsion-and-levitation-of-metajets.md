---
title: Optical propulsion and levitation of metajets
summary: >-
  This paper shows that tiny engineered optical surfaces, or metasurfaces, can
  be made to move when light shines on them. The authors call the moving objects
  "metajets." Instead of being passively pushed by light, each metajet redirects
  incoming light at a designed angle using nanoscale silicon pillars. Because
  photons carry momentum, changing the outgoing direction of the light produces
  an opposite reaction force on the metajet. In the experiments, free-standing
  metajets moved sideways and lifted upward under laser illumination. Changing
  the nanopillar pattern changed the refraction efficiency, light-bending angle,
  and speed, supporting the idea that the motion comes from engineered optical
  recoil rather than random drift. The work is best read as a proof-of-concept
  for programmable light-driven forces at the microscale, with possible future
  relevance to microrobotics and much more speculative light-sail propulsion.
whyItMatters: >-
  The study reframes metasurfaces as mechanical agents, not just passive optical
  components. By programming how a surface changes the momentum of light, the
  authors show a route to programmable 3D motion using light alone.
limitations: >-
  This is still a controlled microscale laboratory demonstration: speeds are in
  micrometres per second, the devices move in a liquid cell under carefully
  aligned laser illumination, and the levitation is constrained by the sample
  chamber. Scaling the principle to practical microrobots or large light sails
  would require major engineering work.
authors:
  - Kaushik Kudtarkar
  - Yixin Chen
  - Ziqiang Cai
...
capturedAt: '2026-04-25T08:57:08+01:00'
draft: false
---
## Summary
...
<img src="../../images/metajets-infographic.png" alt="Simple infographic explaining how a metajet bends light to create sideways propulsion and upward lift" />

## Source
- DOI: [10.1016/j.newton.2026.100471](https://doi.org/10.1016/j.newton.2026.100471)
- URL: [https://doi.org/10.1016/j.newton.2026.100471](https://doi.org/10.1016/j.newton.2026.100471)
