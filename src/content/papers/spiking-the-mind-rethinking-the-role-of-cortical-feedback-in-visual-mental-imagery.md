---
title: "Spiking the Mind: Rethinking the Role of Cortical Feedback in Visual Mental Imagery"
summary: >-
  This article proposes a new framework for visual mental imagery. Instead of
  treating imagery as weakened perception driven by spike-causing top-down
  feedback into early visual cortex, the authors argue that cortical feedback in
  V1/V2 is typically sparse, modulatory, and slower than feedforward input.
  They introduce the Spontaneous-Activity Reshaping Hypothesis: imagery works
  mainly by reshaping ongoing spontaneous activity, selectively amplifying
  neurons aligned with imagined features while suppressing irrelevant
  populations. This account explains key empirical signatures of imagery,
  including reduced resolution and contrast, slower buildup, and priming-dominant
  aftereffects relative to adaptation.
whyItMatters: >-
  The paper gives a mechanistic reinterpretation of a core cognitive process and
  reconciles multiple findings that are hard to fit with a pure “imagery equals
  weak perception” account. It also generates concrete, testable predictions for
  neurophysiology and psychophysics.
limitations: >-
  The proposed reshaping mechanism is argued to apply most directly to early
  visual cortex, while higher-order visual areas may still support stronger
  recurrent spiking feedback. Much of the evidence is synthesized from existing
  anatomy, physiology, and behavioral data rather than direct single-neuron
  recordings during imagery, so key claims require targeted neural tests. The
  paper also suggests task-dependent switching between modulatory and spiking
...
capturedAt: '2026-04-22T09:32:00.000Z'
draft: false
---
## Summary
...
<img src="../../images/spiking-the-mind-infographic.png" alt="Spiking the Mind conceptual summary infographic" />
